...
class Localization
{
	...
	/// \brief A value between -1 and 1, that keeps record of direction generated by
	/// the random normal distribution when finding new heuristic
	int m_direction_noise;
